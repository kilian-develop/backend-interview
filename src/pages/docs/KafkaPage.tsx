...
const tabGroups = [
  {
    label: 'Kafka',
    tabs: [
      { id: 'kafka-overview', label: 'Kafka 개요', icon: '📡' },
      { id: 'kafka-producer-consumer', label: 'Producer & Consumer', icon: '🔄' },
      { id: 'kafka-delivery-patterns', label: '전달 보장 & 패턴', icon: '🎯' },
      { id: 'kafka-connect-ops', label: 'Connect & 운영', icon: '⚙️' },
    ],
  },
]
